    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center my-3"><b>FILE COMPLAINT</b></h5>
                    <?php
                      $pat = $_SESSION['donar'];
                      $sel = mysqli_query($connect,"SELECT * FROM donars WHERE username='$pat'");
                      ...
                      if(isset($_POST['request']))
                      {
                          ...
                          else
                          {
                                ...
                                $qq="SELECT * FROM seeker where username='$to'";
                                    ...
                                    echo "<script>alert('Invalid Field Entered')</script>";
                                }
