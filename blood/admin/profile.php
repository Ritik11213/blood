                    ...
                    <div class="row">
                        <div class="col-md-6 my-3">
                                ...
                                <table class="table table-border-bordered">
                                    <tr>
                                        <th colspan="2" class="text-center"><h5><b>My Profile</b></h5></th>
                                    </tr>
                                    <tr>
                                        <td>Name</td>
                        ...
                        <div class="col-md-6">
                            ...
                            <?php
                                ...
                                if(isset($_POST['change']))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            $query = "UPDATE admin SET password='$new' WHERE username='$patient'";
                            ...
                            <h5 class="my-4 text-center"><b>Change Password</b></h5>
                            <form method="post">
